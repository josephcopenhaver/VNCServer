...
public class Client {
    ...
    public static enum CLIENT_PROPERTIES implements TypeSafeEnumPropertyPattern {
        DEFAULT_VIEW_MODE(VIEW_MODE.NORMAL_SCROLLING), DEFAULT_ACCESS_MODE(
                ACCESS_MODE.VIEW_ONLY), REMOTE_ADDRESS(""), REMOTE_PORT(1987), REMOTE_DISPLAY_NUM(
                null), SYNCHRONIZE_CLIPBOARD(Boolean.FALSE), MONITOR_SCANNING_PERIOD(
                Long.valueOf(mustParseISO8601DurationRP("T1S", startTime)))
        ...
        public void setValue(Object value) {
            ...
            case MONITOR_SCANNING_PERIOD:
                if (value instanceof String) {
                    value = Long.valueOf(mustParseISO8601DurationRP(
            ...
            case DEFAULT_ACCESS_MODE:
                if (value instanceof String) {
                    ...
                    for (ACCESS_MODE accessMode : ACCESS_MODE.values()) {
                        ...
                        value = (accessMode == ACCESS_MODE.ALL) ? this.value
                                : accessMode;
                        break;
                    }
                }
