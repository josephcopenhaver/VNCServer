...
public class Handler extends
        com.jcope.vnc.shared.input.Handler<ClientHandler, CLIENT_EVENT> {
    ...
    private static Class<?>[] bootStraps = new Class<?>[] {
            AcknowledgeNonSerialEvent.class, ClipboardChanged.class,
            EnableAliasMonitor.class, EnableConnectionMonitor.class,
            GetClipboard.class, GetScreenSegment.class, OfferInput.class,
            RequestAlias.class, SelectScreen.class, SendChatMsg.class,
            SetClipboard.class, SetScreenMonitorPaused.class };
