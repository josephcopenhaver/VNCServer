...
public class GetScreenSegment extends Handle {
    ...
    public void handle(ClientHandler client, Object[] args) {
        ...
        Object arg0 = args[0];
        assert_(((arg0 instanceof Integer) && ((Integer) arg0) == -1)
                || arg0 instanceof FixedLengthBitSet);
        ...
        client.dispatchTransaction(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    for (int segmentID = flbs.nextSetBit(0); segmentID >= 0; segmentID = flbs
                            .nextSetBit(segmentID + 1)) {
                        GraphicsSegment graphicsSegment = f_client
                                .getSegment(segmentID);
                        f_client.sendEvent(SERVER_EVENT.SCREEN_SEGMENT_UPDATE,
                                segmentID, graphicsSegment);
                    }
                } finally {
