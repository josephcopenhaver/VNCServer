...
public class MainFrame extends JFrame {
    ...
    private HashMap<VIEW_MODE, ActionListener> viewModeActions = new HashMap<VIEW_MODE, ActionListener>(
            VIEW_MODE.values().length);
    ...
    public MainFrame(final StateMachine stateMachine) {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowIconified(WindowEvent evt) {
                stateMachine.sendEvent(CLIENT_EVENT.SET_SCREEN_MONITOR_PAUSED,
                        true);
                try {
        ...
        if (DEBUG) {
            ...
            JMenuItem actionInvalidateScreen = new JMenuItem(
                    "Invalidate Screen");
        ...
        sendSpecialCAD.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                KeyEvent keyEvent = new KeyEvent(sendSpecialCAD, 0, 0L,
                        KeyEvent.CTRL_DOWN_MASK | KeyEvent.ALT_DOWN_MASK,
                        KeyEvent.VK_DELETE, (char) 127);
                InputEvent eventDown = new InputEvent(INPUT_TYPE.KEY_DOWN,
                        keyEvent);
        ...
        refreshScreen.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,
                CTRL_DOWN_MASK));
        refreshScreen.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent ae) {
                client.sendEvent(CLIENT_EVENT.GET_SCREEN_SEGMENT,
                        Integer.valueOf(-1));
            }
        });
        ...
        setAlias.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                String result = JCOptionPane.showInputDialog(fthis,
                        "What would you like your alias to be?", alias);
                if (result != null) {
                    if (result.equals("")) {
                ...
                if (imagePanel != null) {
                    stateMachine.handleUserAction(new Runnable() {
                        ...
                        public void run() {
                            ...
                            factorsThatStretchToFit(imagePanelSize.width,
                                    imagePanelSize.height,
                                    contentPaneSize.width,
                                    contentPaneSize.height, scaleFactors);

                            lSpace = (int) Math
                                    .floor((((float) contentPaneSize.width) - ((float) imagePanelSize.width)
                                            * scaleFactors.width) / 2.0f);
                            tSpace = (int) Math
                                    .floor((((float) contentPaneSize.height) - ((float) imagePanelSize.height)
                                            * scaleFactors.height) / 2.0f);

                            imagePanel.setScaleFactors(lSpace, tSpace,
                                    scaleFactors);
                        }
        ...
        // TODO: define accelerator
        normalScrollingScreen
                .addActionListener((tmpActionListener = new ActionListener() {
        ...
        fitScreen.addActionListener((tmpActionListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                // To actually see this work, view a small screen on a larger
                // screen
                if (imagePanel != null) {
                    stateMachine.handleUserAction(new Runnable() {
                        ...
                        public void run() {
                            ...
                            imagePanel.getImageSize(imagePanelSize);
                            factorsThatShrinkToFitWithin(imagePanelSize.width,
                                    imagePanelSize.height,
                                    contentPaneSize.width,
                                    contentPaneSize.height, scaleFactors);
        ...
        viewModeActions.get(
                (VIEW_MODE) CLIENT_PROPERTIES.DEFAULT_VIEW_MODE.getValue())
        ...
        try {
            ...
            if (device.isFullScreenSupported()) {
                if (enabled) {
                    ...
                    if (device.equals(GraphicsEnvironment
                            .getLocalGraphicsEnvironment()
                            .getDefaultScreenDevice())
                            && (insets = Toolkit.getDefaultToolkit()
                                    .getScreenInsets(
                                            device.getDefaultConfiguration())) != null
            ...
            try {
                ...
                if (enabled) {
                    ...
                    setExtendedState(getExtendedState()
                            ^ (JFrame.MAXIMIZED_BOTH | JFrame.MAXIMIZED_HORIZ | JFrame.MAXIMIZED_VERT));
    ...
    public void validate() {
        ...
        if (lastWidth != contentPaneSize.width
                || lastHeight != contentPaneSize.height) {
