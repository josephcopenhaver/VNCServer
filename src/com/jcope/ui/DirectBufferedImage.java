...
public class DirectBufferedImage extends BufferedImage {
    ...
    public DirectBufferedImage(int[] src, int size, int width, int height,
            boolean hasAlpha) {
        super((dcm = (dcm != null) ? dcm : new DirectColorModel(32, 0xff0000,
                0xff00, 0xff, (hasAlpha ? 0x00000000 : 0xff000000))), Raster
                .createWritableRaster(
                        dcm.createCompatibleSampleModel(width, height),
                        new DataBufferInt(src, size), null), false,
