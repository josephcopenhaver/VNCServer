...
public class Net
{
    public static final String IPV_4_6_REGEX_STR = "^(?:\\d\\d?|1\\d\\d|2[0-4]\\d|25[0-5])\\.(?:\\d\\d?|1\\d\\d|2[0-4]\\d|25[0-5])\\.(?:\\d\\d?|1\\d\\d|2[0-4]\\d|25[0-5])\\.(?:\\d\\d?|1\\d\\d|2[0-4]\\d|25[0-5])(?:\\.(?:\\d\\d?|1\\d\\d|2[0-4]\\d|25[0-5])\\.(?:\\d\\d?|1\\d\\d|2[0-4]\\d|25[0-5]))?$";
