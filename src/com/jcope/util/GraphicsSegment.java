...
public class GraphicsSegment {
    ...
    public JitCompressedEvent acquireJitCompressedEvent(Object id,
            Object serialized) {
        JitCompressedEvent rval = jce;

        if (rval == null) {
            rval = JitCompressedEvent.getInstance(
                    SERVER_EVENT.SCREEN_SEGMENT_UPDATE, new Object[] { id,
                            serialized });
            jce = rval;
        }
        rval.acquire();
