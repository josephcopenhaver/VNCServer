...
public class LLog {
    ...
    /**
     * Currently not thread safe, but then again I am only trying to cut down on
     * debug messages being spat out at runtime
     * 
     * @param e
     * @return
     */
    ...
    public static void logEvent(final String source, final SERVER_EVENT event,
            final Object[] args) {
        if (!DEBUG) {
            return;
        }
    ...
    public static void logEvent(final String source, final CLIENT_EVENT event,
            final Object[] args) {
        if (!DEBUG) {
            return;
        }
    ...
    private static void _logEvent(final String source, final Object event,
            final Object[] args) {
        String eventName;
